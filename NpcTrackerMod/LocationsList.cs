...
namespace NpcTrackerMod
{
    ...
    {
        public Dictionary<string, (List<Point>, List<string>)> LocationsTeleportCord_Vanilla { get; }

        public LocationsList()
        {
            LocationsTeleportCord_Vanilla = new Dictionary<string, (List<Point>, List<string>)>
            {
        ...
        public string GetTeleportLocation(string currentLocation, Point npcPosition)
        {
            ...
            {
                var points = teleportData.Item1;
                var destinations = teleportData.Item2;
